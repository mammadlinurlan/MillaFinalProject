#pragma checksum "C:\Users\MACBOOK\source\repos\FinalProjectNurlan\FinalProjectNurlan\Views\Order\Cart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5ee8b3b8a45f417ce862a719876a819043eafa14"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5ee8b3b8a45f417ce862a719876a819043eafa14", @"/Views/Order/Cart.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5ee8b3b8a45f417ce862a719876a819043eafa147227", async() => {
                WriteLiteral(@"
...
#nullable disable
            WriteLiteral("\r\n                                        </td>\r\n                                    </tr>\r\n                                </tbody>\r\n                            </table>\r\n\r\n                            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5ee8b3b8a45f417ce862a719876a819043eafa1410960", async() => {
...
<script>
    ...
    $(document).ready(function () {
        ...
        fetch(partialurl).then(res => res.text()).then(data => {
            ...
            fetch(urlforprice).then(res => res.text()).then(");
                WriteLiteral(@"data => {
        ...
        $(document).on(""change"", "".quantityClick"", function () {
            ...
            var produ");
                WriteLiteral(@"ctId = $(this).next().next().next().next().val();
            ...
            fetch(url).then(res => res.text()).then(data => {
                ...
                $(""input[type='number']"").inputSpinner();
                $(""input[type='number']"").next().addClass(""input-spinner"")
                $("".btn-outline-secondary"").removeCla");
                WriteLiteral(@"ss(""btn-outline-secondary"")
                $("".btn-outline-secondary"").removeClass(""btn-outline-secondary"")
        ...
        $(document).on(""click"", "".cart-remove-btn"", function (e) {
            ...
            fetch(comp).then(res => res.text()).then(data => {
                ...
                fetch(partialurl).then(res => res.text()).then(data => {
                    ...
                    $("".forPartial"").empty();
      ");
                WriteLiteral(@"              $("".forPartial"").append(data);
